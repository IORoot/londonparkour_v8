...
$lp_default_principles = array(
	array(
		...
		'label'   => 'SEE, HEAR, DO',
		'body'    => "The coach shows you, tells you, then lets you try. They're with you the whole way. Learn the way you want to.",
	),
	array(
	...
	array(
		...
		'body'    => 'Every session is coached. The class learns together, at the pace of the people in it.',
	),
);
