...
return array(
	...
	'sub_fields' => array_merge(
		...
		array(
			...
			array(
				'name'          => 'focus_x',
				'label'         => __( 'Subject, left to right', 'londonparkour_v8' ),
				'type'          => 'number',
				'default_value' => 50,
				'min'           => 0,
				'max'           => 100,
				'step'          => 1,
				'append'        => '%',
				'instructions'  => __( 'Where the subject sits across the photograph. 0 is the left edge, 50 the middle, 100 the right. Used when Media slides is empty. The crop and the zoom share this point.', 'londonparkour_v8' ),
			),
			array(
				'name'          => 'focus_y',
				'label'         => __( 'Subject, top to bottom', 'londonparkour_v8' ),
				'type'          => 'number',
				'default_value' => 50,
				'min'           => 0,
				'max'           => 100,
				'step'          => 1,
				'append'        => '%',
				'instructions'  => __( 'Where the subject sits down the photograph. 0 is the top, 50 the middle, 100 the bottom.', 'londonparkour_v8' ),
			),
			array(
				'name'         => 'media_slides',
				...
				'sub_fields'   => array(
					...
					array(
						...
						'type'          => 'text',
						'default_value' => '50% 50%',
						'instructions'  => __( 'Where this slide’s subject sits, as "left% top%". 50% 50% is the middle. The crop and the zoom both use it.', 'londonparkour_v8' ),
					),
					array(
						'name'         => 'coordinates',
