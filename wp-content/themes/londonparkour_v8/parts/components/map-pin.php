 ...
 * sprite glyph. `flagship` recolours either one.
 *
...
?>
<?php if ( $lp_is_link ) : ?>
<a class="<?php echo esc_attr( $lp_root ); ?>" data-component="map-pin" href="<?php echo esc_url( $lp_href ); ?>">
<?php else : ?>
<span class="<?php echo esc_attr( $lp_root ); ?>" data-component="map-pin">
<?php endif; ?>
