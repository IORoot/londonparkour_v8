...
$lp_body = array(
	'featured' => 'flex-1 min-w-0 flex flex-col justify-between px-7 py-6 bg-secondary border-r border-neutral-content/10',
	'default'  => 'flex-1 min-w-0 flex flex-col justify-between px-6 py-5 bg-secondary border-r border-neutral-content/10',
);
...
>
	...
	<div class="<?php echo lp_classes( $lp_body[ $lp_size ] ); ?>">
	...
	<div class="<?php echo lp_classes( $lp_rail[ $lp_rail_key ] ); ?>">
