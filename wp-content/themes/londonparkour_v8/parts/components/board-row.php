...
$lp_sizes = array(
	'default' => array(
		...
		'session'     => 'flex-1 min-w-[10rem] flex flex-col gap-[5px]',
		'title'       => 'font-heading text-[17px] font-medium tracking-[-0.2px] text-neutral-content break-words',
		'subtitle'    => 'font-label text-[11px] font-normal tracking-[0.2px] text-neutral-content/50 break-words',
		'site'        => 'flex items-center gap-2 min-w-0 lg:hidden xl:flex xl:w-[150px] xl:shrink-0',
		'site_pin'    => 'text-neutral-content/50 group-hover:text-neutral-content/80 transition-colors duration-150',
		'site_label'  => 'font-label text-[12px] font-normal tracking-[0.2px] text-neutral-content/80 group-hover:text-neutral-content transition-colors duration-150 break-words xl:truncate',
		'level'       => 'flex items-center gap-2 min-w-0 lg:hidden 2xl:flex 2xl:w-[146px] 2xl:shrink-0',
		'level_mark'  => 'text-neutral-content/80',
		'level_label' => 'font-label text-[11px] font-normal tracking-[0.2px] text-neutral-content/80 break-words 2xl:truncate',
...
if ( $lp_now_playing ) {
	...
	$lp_ui['glyph_wrap']  = 'hidden min-[1680px]:inline-flex w-7 h-7 shrink-0 text-primary-content items-center justify-center';
