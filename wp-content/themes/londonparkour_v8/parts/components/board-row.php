...
$lp_sizes = array(
	'default' => array(
		'root'        => 'group relative flex flex-col gap-[10px] lg:flex-row lg:items-center lg:gap-[24px] w-full py-[14px] lg:py-[18px] px-[16px] lg:px-[28px] bg-secondary hover:bg-neutral border-b border-neutral-content/10 transition-colors duration-150 no-underline text-left',
		...
		'glyph_wrap'  => 'hidden lg:inline-flex w-7 h-7 shrink-0 text-neutral-content items-center justify-center',
		'glyph_icon'  => 'w-7 h-7',
		'pin_icon'    => 'w-3 h-3',
		'level_icon'  => 'w-3.5 h-3.5',
		'session'     => 'flex-1 min-w-0 flex flex-col gap-[5px]',
		'title'       => 'font-heading text-[17px] font-medium tracking-[-0.2px] text-neutral-content break-words lg:truncate',
		'subtitle'    => 'font-label text-[11px] font-normal tracking-[0.2px] text-neutral-content/50 break-words lg:truncate',
		'site'        => 'flex items-center gap-2 min-w-0 lg:w-[150px] lg:shrink-0',
		'site_pin'    => 'text-neutral-content/50 group-hover:text-neutral-content/80 transition-colors duration-150',
		'site_label'  => 'font-label text-[12px] font-normal tracking-[0.2px] text-neutral-content/80 group-hover:text-neutral-content transition-colors duration-150 break-words lg:truncate',
		'level'       => 'flex items-center gap-2 min-w-0 lg:w-[146px] lg:shrink-0',
		'level_mark'  => 'text-neutral-content/80',
		'level_label' => 'font-label text-[11px] font-normal tracking-[0.2px] text-neutral-content/80 break-words lg:truncate',
	...
	'lg'      => array(
		...
		'glyph_wrap'  => 'hidden lg:inline-flex w-10 h-10 shrink-0 text-neutral-content group-hover:text-neutral items-center justify-center',
		'glyph_icon'  => 'w-10 h-10',
		'pin_icon'    => 'w-4 h-4',
		'level_icon'  => 'w-4 h-4',
		'session'     => 'flex-1 min-w-0 flex flex-col gap-1.5 lg:gap-2',
		'title'       => 'font-heading text-[18px] lg:text-[22px] font-medium tracking-[-0.4px] text-neutral-content group-hover:text-neutral break-words lg:truncate',
		'subtitle'    => 'font-label text-[12px] lg:text-[13px] font-normal tracking-[0.2px] text-neutral-content/50 group-hover:text-neutral break-words lg:truncate',
		'site'        => 'flex items-center gap-2 lg:gap-2.5 min-w-0 lg:w-[168px] lg:shrink-0',
		'site_pin'    => 'text-neutral-content/50 group-hover:text-neutral transition-colors duration-150',
		'site_label'  => 'font-label text-[12px] lg:text-[14px] font-normal tracking-[0.2px] text-neutral-content/80 group-hover:text-neutral transition-colors duration-150 break-words lg:truncate',
		'level'       => 'flex items-center gap-2 lg:gap-2.5 min-w-0 lg:w-[164px] lg:shrink-0',
		'level_mark'  => 'text-neutral-content/80 group-hover:text-neutral',
		'level_label' => 'font-label text-[11px] lg:text-[13px] font-normal tracking-[0.2px] text-neutral-content/80 group-hover:text-neutral break-words lg:truncate',
		'fare_mobile' => 'flex flex-col items-end gap-[2px] shrink-0 lg:hidden',
...
if ( $lp_now_playing ) {
	...
	$lp_ui['glyph_wrap']  = 'hidden lg:inline-flex w-7 h-7 shrink-0 text-primary-content items-center justify-center';
...
<?php endif; ?>
	...
	<div class="flex flex-col gap-2 lg:contents">
		...
		<div class="flex flex-wrap items-center gap-x-3 gap-y-1 lg:contents">
	...
	<div class="flex items-center justify-end gap-3 pt-3 border-t border-neutral-content/10 lg:contents lg:border-0 lg:pt-0">
		<?php if ( $lp_is_sell ) : ?>
