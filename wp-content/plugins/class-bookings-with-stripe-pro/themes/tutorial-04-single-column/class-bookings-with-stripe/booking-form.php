<?php
/**
 * Tutorial 04 — single-column layout.
 *
 * Each field is rendered on its own row (no cbfs-form__grid--2 wrapper).
 *
...
?>
<div class="cbfs-form cbfs-form--layout-modern cbfs-tut04" data-cbfs-class-id="<?php echo esc_attr( (string) $class_data['id'] ); ?>" data-cbfs-origin="<?php echo esc_attr( $origin ); ?>">
