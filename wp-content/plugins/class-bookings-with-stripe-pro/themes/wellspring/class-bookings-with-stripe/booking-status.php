<?php
/**
 * Wellspring — status pages (confirmed / cancelled / error).
 *
...
?>
<div class="cbfs-status cbfs-status--layout-modern cbfs-wellspring cbfs-status--<?php echo esc_attr( $status_class ); ?>"<?php echo $session_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="cbfs-wellspring__canvas">
		<div class="cbfs-wellspring__card cbfs-wellspring__card--status">
