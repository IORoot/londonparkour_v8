<?php
/**
 * Tutorial 07 — add an SVG graphic to the form.
 *
 * require accent.svg.php below, or swap in your own .svg.php partial.
 *
...
?>
<div class="cbfs-form cbfs-form--layout-modern cbfs-tut07" data-cbfs-class-id="<?php echo esc_attr( (string) $class_data['id'] ); ?>" data-cbfs-origin="<?php echo esc_attr( $origin ); ?>">
	<div class="cbfs-form__surface">
		...
		<div class="cbfs-form__body">
			...
			<?php else : ?>
				<div class="cbfs-tut07__accent-wrap">
					<?php require __DIR__ . '/accent.svg.php'; ?>
				</div>
