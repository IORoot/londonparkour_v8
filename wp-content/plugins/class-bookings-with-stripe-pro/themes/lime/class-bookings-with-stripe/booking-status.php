<?php
/**
 * Lime — status pages (confirmed / cancelled / error).
 *
...
?>
<div class="cbfs-status cbfs-status--layout-modern cbfs-lime cbfs-status--<?php echo esc_attr( $status_class ); ?>"<?php echo $session_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="cbfs-lime__card cbfs-lime__card--solo cbfs-lime__card--status">
