...
### H8 — 67 KB of booking JavaScript on every page, including pages that cannot book — **FIXED 2026-09-08**
...
**Shipped.** Theme dequeue in `app/setup/clasbpro.php`. Zero `cbfs-*` on
`/contact/`, `/tutorials/`, `/blog/`, `/about/`, `/docs/`, `/classes-map/`.
Assets remain on homepage, `/classes/`, class pages, `/coupons/`,
`/private-coaching/`, `/workshops/`. Plugin untouched.
